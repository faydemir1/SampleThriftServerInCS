...
namespace APIGateway.Thrift.Generated.BaseTypes
{
  ...
  public partial class QueueMessage : TBase
  {
    ...
    public QueueMessage DeepCopy()
    {
      var tmp2 = new QueueMessage();
      if((UniqueId != null) && __isset.uniqueId)
      {
        tmp2.UniqueId = this.UniqueId;
      }
      tmp2.__isset.uniqueId = this.__isset.uniqueId;
      if((BusinessKey != null) && __isset.businessKey)
      {
        tmp2.BusinessKey = this.BusinessKey;
      }
      tmp2.__isset.businessKey = this.__isset.businessKey;
      if((Base64Data != null) && __isset.base64Data)
      {
        tmp2.Base64Data = this.Base64Data;
      }
      tmp2.__isset.base64Data = this.__isset.base64Data;
      return tmp2;
    }
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 3:
              if (field.Type == TType.String)
              {
                Base64Data = await iprot.ReadStringAsync(cancellationToken);
              }
              else
              {
                await TProtocolUtil.SkipAsync(iprot, field.Type, cancellationToken);
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var struc = new TStruct("QueueMessage");
        ...
        if((Base64Data != null) && __isset.base64Data)
        {
          ...
          field.ID = 3;
          await oprot.WriteFieldBeginAsync(field, cancellationToken);
          await oprot.WriteStringAsync(Base64Data, cancellationToken);
          await oprot.WriteFieldEndAsync(cancellationToken);
        }
    ...
    {
      if (!(that is QueueMessage other)) return false;
      ...
      return ((__isset.uniqueId == other.__isset.uniqueId) && ((!__isset.uniqueId) || (System.Object.Equals(UniqueId, other.UniqueId))))
        ...
        && ((__isset.base64Data == other.__isset.base64Data) && ((!__isset.base64Data) || (System.Object.Equals(Base64Data, other.Base64Data))));
    }
    ...
    public override int GetHashCode() {
      ...
      unchecked {
        ...
        if((Base64Data != null) && __isset.base64Data)
        {
          hashcode = (hashcode * 397) + Base64Data.GetHashCode();
        }
      }
      return hashcode;
    }
