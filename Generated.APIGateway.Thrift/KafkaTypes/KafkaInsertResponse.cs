...
namespace APIGateway.Thrift.Generated.KafkaTypes
{
  ...
  public partial class KafkaInsertResponse : TBase
  {
    private int _value;
    ...
    public KafkaInsertResponse()
    {
    }

    public KafkaInsertResponse DeepCopy()
    {
      var tmp2 = new KafkaInsertResponse();
      if(__isset.@value)
      {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var struc = new TStruct("KafkaInsertResponse");
    ...
    {
      if (!(that is KafkaInsertResponse other)) return false;
    ...
    {
      var sb = new StringBuilder("KafkaInsertResponse(");
      int tmp7 = 0;
      if(__isset.@value)
      {
        if(0 < tmp7++) { sb.Append(", "); }
